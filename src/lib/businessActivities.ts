...
type SeoDescriptorOverride = string;

const SEO_DESCRIPTOR_OVERRIDES: Record<string, SeoDescriptorOverride> = {
  restaurant: "Restaurante brasileiro",
  pizzeria: "Pizzaria brasileira",
  churrascaria: "Churrascaria brasileira",
  bakery: "Padaria brasileira",
  cafe: "Caf\u00e9 brasileiro",
  confectionery: "Confeitaria brasileira",
  market: "Mercado brasileiro",
  buffet: "Buffet brasileiro",
  bar: "Bar brasileiro",
  snack_bar: "Lanchonete brasileira",
  food_truck: "Food Truck brasileiro",
  catering: "Catering brasileiro",
  medical_clinic: "Cl\u00ednica brasileira",
  doctor: "M\u00e9dico brasileiro",
  doctor_female: "M\u00e9dica brasileira",
  pediatrician: "Pediatra brasileiro",
  dentist: "Dentista brasileiro",
  depilation: "Depila\u00e7\u00e3o brasileira",
  manicure: "Manicure brasileira",
  physiotherapy: "Fisioterapeuta brasileiro",
  psychology: "Psic\u00f3logo brasileiro",
  psychologist_female: "Psic\u00f3loga brasileira",
  nutrition: "Nutricionista brasileiro",
  hairdresser: "Cabeleireiro brasileiro",
  hairdresser_female: "Cabeleireira brasileira",
  beauty_salon: "Sal\u00e3o de beleza brasileiro",
  barbershop: "Barbearia brasileira",
  aesthetics: "Est\u00e9tica brasileira",
  personal_trainer: "Personal trainer brasileiro",
  mechanic: "Oficina mec\u00e2nica brasileira",
  body_shop: "Funilaria e pintura brasileira",
  tires: "Borracharia brasileira",
  auto_electric: "Autoel\u00e9trica brasileira",
  car_wash: "Lava Car brasileiro",
  towing: "Guincho brasileiro",
  dealership: "Concession\u00e1ria brasileira",
  car_dealership: "Revenda de carros brasileira",
  automotive_center: "Centro automotivo brasileiro",
  paintless_dent_repair: "Martelinho de ouro brasileiro",
  detailing: "Est\u00e9tica automotiva brasileira",
  construction_company: "Construtora brasileira",
  general_contractor: "Empreiteiro brasileiro",
  electrician: "Eletricista brasileiro",
  plumber: "Encanador brasileiro",
  painter: "Pintor brasileiro",
  carpenter: "Marceneiro brasileiro",
  engineer: "Engenheiro brasileiro",
  architect: "Arquiteto brasileiro",
  gardener: "Jardineiro brasileiro",
  lawyer: "Advogado brasileiro",
  lawyer_female: "Advogada brasileira",
  translator: "Tradutor brasileiro",
  translator_female: "Tradutora brasileira",
  notary: "Not\u00e1rio brasileiro",
  notary_female: "Not\u00e1ria brasileira",
  brazilian_store: "Produtos brasileiros",
  immigration_consultant: "Consultoria de imigra\u00e7\u00e3o",
  accountant: "Contador brasileiro",
  accountant_female: "Contadora brasileira",
  financial_advisor: "Consultor financeiro brasileiro",
  financial_advisor_female: "Consultora financeira brasileira",
  insurance_broker: "Corretor de seguros brasileiro",
  insurance_broker_female: "Corretora de seguros brasileira",
  remittance: "C" + String.fromCharCode(0xE2) + "mbio e remessas",
  tax_preparation: "Imposto de renda",
  teacher: "Professor brasileiro",
  teacher_female: "Professora brasileira",
  english_teacher: "Professor de ingl" + String.fromCharCode(0xEA) + "s brasileiro",
  english_teacher_female: "Professora de ingl" + String.fromCharCode(0xEA) + "s brasileira",
  driving_school: "Autoescola brasileira",
  school: "Escola brasileira",
  supermarket: "Supermercado brasileiro",
  retail_market: "Mercado brasileiro",
  fashion: "Moda brasileira",
  clothing_store: "Loja de roupas brasileira",
  beauty_store: "Produtos de beleza brasileiros",
  lingerie: "Roupa " + String.fromCharCode(0xED) + "ntima brasileira",
  furniture_store: "Decora" + String.fromCharCode(0xE7) + String.fromCharCode(0xE3) + "o brasileira",
  gift_shop: "Lembran" + String.fromCharCode(0xE7) + "as brasileiras",
  moving_company: "Empresa de mudan" + String.fromCharCode(0xE7) + "a brasileira",
  freight_logistics: "Frete brasileiro",
  passenger_transport: "Transporte de passageiros",
  van_service: "Servi" + String.fromCharCode(0xE7) + "o de van brasileiro",
  cat_boarding: "Hospedagem para gatos",
  dog_boarding: "Hospedagem para c" + String.fromCharCode(0xE3) + "es",
  grooming: "Banho e tosa brasileiro",
  veterinary: "Cl" + String.fromCharCode(0xED) + "nica veterin" + String.fromCharCode(0xE1) + "ria brasileira",
  veterinarian: "Veterin" + String.fromCharCode(0xE1) + "rio brasileiro",
  pet_training: "Adestramento brasileiro",
  dog_walker: "Passeador de c" + String.fromCharCode(0xE3) + "es brasileiro",
  pet_shop: "Pet Shop brasileiro",
  daycare: "Creche infantil brasileira",
  babysitter: "Bab" + String.fromCharCode(0xE1) + " brasileira",
  elderly_caregiver: "Cuidador de idosos brasileiro",
  elderly_caregiver_female: "Cuidadora de idosos brasileira",
  nurse: "Enfermeiro brasileiro",
  nurse_female: "Enfermeira brasileira",
  home_care: "Assist" + String.fromCharCode(0xEA) + "ncia domiciliar brasileira",
  diarist: "Diarista brasileira",
  home_cleaning: "Servi" + String.fromCharCode(0xE7) + "o de limpeza residencial brasileiro",
  commercial_cleaning: "Servi" + String.fromCharCode(0xE7) + "o de limpeza comercial brasileiro",
  real_estate_agency: "Imobili" + String.fromCharCode(0xE1) + "ria brasileira",
  realtor: "Corretor de im" + String.fromCharCode(0xF3) + "veis brasileiro",
  realtor_female: "Corretora de im" + String.fromCharCode(0xF3) + "veis brasileira",
  property_management: "Administra" + String.fromCharCode(0xE7) + String.fromCharCode(0xE3) + "o de im" + String.fromCharCode(0xF3) + "veis",
  mortgage_broker: "Consultoria de financiamento de im" + String.fromCharCode(0xF3) + "veis",
  property_inspection: "Vistoria de im" + String.fromCharCode(0xF3) + "veis",
  sertanejo: "Sertanejo brasileiro",
  rock_band: "Banda de Rock brasileira",
  forro_band: "Banda de Forr" + String.fromCharCode(0xF3) + " brasileira",
  chorinho: "Chorinho brasileiro",
  samba: "Samba brasileiro",
  funk: "Funk brasileiro",
  pagode_group: "Grupo de pagode brasileiro",
  choir: "Coro brasileiro",
  photographer: "Fot" + String.fromCharCode(0xF3) + "grafo brasileiro",
  musician: "M" + String.fromCharCode(0xFA) + "sico brasileiro",
  music: "M" + String.fromCharCode(0xFA) + "sica brasileira",
  musicista: "Musicista brasileiro",
  dj: "DJ brasileiro",
  designer: "Designer brasileiro",
  performer: "Artista para eventos brasileiro",
  travel_agency: "Ag" + String.fromCharCode(0xEA) + "ncia de turismo brasileira",
  tour_guide: "Guia de turismo brasileiro",
  tours: "Passeios e excurs" + String.fromCharCode(0xF5) + "es",
  travel_insurance: "Seguro viagem",
  accommodation: "Hospedagem brasileira",
  hotel: "Hotel brasileiro",
};
...
export function getPrimaryActivityLabel(
  ...
  if (activityId === OTHER_PRIMARY_ACTIVITY_ID) {
    return normalizePrimaryActivityCustom(customValue);
  }
...
export function getPrimaryActivitySeoLabel(
  ...
  return SEO_DESCRIPTOR_OVERRIDES[activityId] || activityLabel;
}
