        ...
        <div className="mb-8">
          <Link to={"/"} className="flex items-center gap-3 mb-4">
            <div className="w-20 h-20 flex items-center justify-center">
                <img src="/logo-112.webp" srcSet="/logo-64.webp 64w, /logo-112.webp 112w" sizes="80px" alt="Caramelinho logo" width={112} height={112} decoding="async" className="w-full h-full object-contain transition-transform duration-200 group-hover:scale-110" />
              </div>
